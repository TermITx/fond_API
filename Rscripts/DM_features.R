...
print("Krecemo")
for (name in names){
  input_file <- read.csv(file = paste(c('C:/Users/Karlo/Desktop/fondovi/python skripte/',name,'.csv'),collapse=""))
  ...
  appendFile <- read.csv(file = paste(c('C:/Users/Karlo/Desktop/fondovi/python skripte/features_',name,'.csv'),collapse=""))
  rbind(appendFile,tail(features,n=1))
  write.csv(features,paste(c('C:/Users/Karlo/Desktop/fondovi/python skripte/features_',name,'.csv'),collapse=""), row.names = FALSE)
